...
public class EditNickname extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSubmit = findViewById(R.id.button_savenew);
        findViewById(R.id.returntogame).setOnClickListener(v -> returnToGame());
        ...
        buttonSubmit.setOnClickListener(v -> {
            ...
            Intent mainIntent = new Intent(EditNickname.this, MainActivity.class);
    ...
    private void returnToGame() {
        ...
        intent.putExtra("PLAYER1_NICKNAME", player1Name);
        intent.putExtra("PLAYER2_NICKNAME", player2Name);
        intent.putExtra("player1Points", player1Points);
        intent.putExtra("player2Points", player2Points);
